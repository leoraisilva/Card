function alteracao(valorSelecionado) {
    document.querySelectorAll('.Perfil, .Criar_Cards, .Meus_Cards, .Rede_social, .ParticipanteAdd,  .Report, .Configuracao, .Logout').forEach(function(valor) {
...
document.querySelectorAll('.Perfil, .Criar_Cards, .Meus_Cards, .Rede_social, .ParticipanteAdd,  .Report, .Configuracao, .Logout').forEach(function(vlw_presente) {
